...
about_txt = \
"""The validator used in this example shows how the validator can be
used to transfer data to and from each text control automatically when
the dialog is shown and dismissed."""
...
class DataXferValidator(wx.PyValidator):
    ...
    def Clone(self):
        "Every validator must be Clone capable"
        return DataXferValidator(self.data, self.key)

    def Validate(self, win): return True # not validating data
