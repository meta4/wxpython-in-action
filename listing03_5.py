...
class TwoButtonEvent(wx.PyCommandEvent):
    def __init__(self, evtType, id):
        ...
        self.clickCount = 0
    def GetClickCount(self): return self.clickCount
    def SetClickCount(self, count): self.clickCount = count

myEVT_TWO_BUTTON = wx.NewEventType() # generate new event type
